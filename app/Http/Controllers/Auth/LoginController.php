...
class LoginController extends Controller
{
    ...
    public function login(Request $request): JsonResponse
    {
        ...
        $defaultMenuArray  = AppLibrary::defaultMenu($this->menuService->menu($user->roles[0]), $defaultPermission);
        // Fallback seguro para evitar "Menu.Undefined" e 404 em /admin/undefined
        if (empty($defaultMenuArray) || !isset($defaultMenuArray['url']) || !$defaultMenuArray['url']) {
            $defaultMenuArray = [
                'url'      => 'dashboard',
                'language' => 'dashboard',
        ...
        $defaultMenu = (object)$defaultMenuArray;
