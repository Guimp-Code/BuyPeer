...
class InstallerController extends Controller
{
    ...
    public function license(): \Illuminate\Http\RedirectResponse|\Illuminate\Routing\Redirector
    {
        // Licença desabilitada para entrega: pular etapa e seguir para configuração do site
        return redirect(route('installer.site'));
    }

    public function licenseStore(Request $request): \Illuminate\Http\RedirectResponse|\Illuminate\Routing\Redirector
    {
        // Licença desabilitada: ignorar validação e seguir
        return redirect(route('installer.site'));
    }
