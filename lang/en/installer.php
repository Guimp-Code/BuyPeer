...
return [
    ...
    'final'       => [
        ...
        'password_info'   => 'Use your own secure password',
        'next'            => 'Finish',
    ],
    'installed'   => [
            'success_log_message' => 'BUYPEER installer successfully INSTALLED on ',
    'update_log_message'  => 'BUYPEER Installer successfully UPDATED on ',
    ],
];
