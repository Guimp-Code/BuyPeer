...
return [
    ...
    'final'       => [
        ...
        'password_info'   => 'নিজের নিরাপদ পাসওয়ার্ড ব্যবহার করুন',
        'next'            => 'শেষ',
    ],
    'installed'   => [
            'success_log_message' => 'BUYPEER ইনস্টলার সফলভাবে ইনস্টল করা হয়েছে ',
    'update_log_message'  => 'BUYPEER ইনস্টলার সফলভাবে আপডেট হয়েছে ',
    ],
];
