...
class SiteTableSeeder extends Seeder
{
    ...
    public function run()
    {
        // Avoid EnvEditor::getValue usage due to PHP 8.4 incompatibility
        Settings::group('site')->set([
            ...
            'site_android_app_link'                      => env('MIX_DEMO', false) ? 'http://android.com' : '',
            'site_ios_app_link'                          => env('MIX_DEMO', false) ? 'http://ios.com' : '',
            'site_copyright'                             => '© BUYPEER by Treppix Tech House ' . Carbon::now()->year . ', All Rights Reserved',
            'site_language_switch'                       => Activity::ENABLE,
            'site_app_debug'                             => Activity::DISABLE,
            'site_auto_update'                           => Activity::DISABLE,
            'site_online_payment_gateway'                => env('MIX_DEMO', false) ? Activity::ENABLE : Activity::DISABLE,
