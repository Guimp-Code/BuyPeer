...
export default {
    ...
    methods: {
        displayModeDefine: function () {
            // Force LTR for entire site
            const dir = "ltr";
            document.documentElement.setAttribute('dir', dir);
            // Ensure global state reflects LTR to avoid persisted RTL from localStorage
            this.$store.dispatch('globalState/set', { display_mode: DisplayModeEnum.LTR }).catch(()=>{});
        }
    },
