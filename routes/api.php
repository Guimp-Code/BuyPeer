...
Route::prefix('auth')->middleware(['installed', 'apiKey', 'localization', 'throttle:auth'])->name('auth.')->namespace('Auth')->group(function () {
    ...
    Route::middleware('auth:sanctum')->group(function () {
        ...
        // Retorna menu, permissions e defaultMenu para repopular a SPA após refresh
        Route::get('/bootstrap', [LoginController::class, 'bootstrap']);
    });
